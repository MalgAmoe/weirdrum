...
var $author$project$Main$parseString = function (string) {
			...
			case 'PlaySequence':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{playing: true}),
					$author$project$Main$playSequence(_Utils_Tuple0));
			case 'StopSequence':
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$playingButton = function (isPlaying) {
	...
	return isPlaying ? A2(
		...
		A2(
			$elm$core$List$cons,
			$elm$html$Html$Events$onClick($author$project$Main$StopSequence),
			buttonStyles),
		_List_fromArray(
			[
		...
		A2(
			$elm$core$List$cons,
			$elm$html$Html$Events$onClick($author$project$Main$PlaySequence),
			buttonStyles),
		_List_fromArray(
			[
